...
@section('content')
    ...
    <div class="container m-auto size-11/12">
        <a href="{{ route('producto.create') }}">
            <button
                class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 border border-green-500 rounded">Nuevo
                Registro</button>
        </a>
        <br>
        <br>
                ...
                <tbody class="block md:table-row-group">
                    <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                class="inline-block w-1/3 md:hidden font-bold">Producto</span><a
                                href="{{ route('producto.show', $prod->id) }}">{{ $prod->nombre }}</a></td>
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
